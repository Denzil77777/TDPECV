...
- Once unzipped, you should see a file; terraform_1.13.2_windows_386.
- Double click and you should see (a) terraform.exe and (b) LICENSE.txt, Right click on terraform.exe.
